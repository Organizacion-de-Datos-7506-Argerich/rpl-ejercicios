...
class TestMethods(unittest.TestCase):
    ...
    def test_padron_mayor_aprobadas_ult_cuatri_simple(self):
        notas_data = [
            ...
            (3, 'Datos', 9, '03-01-2021'),
            (4, 'Datos', 3, '03-01-2019'),
            (5, 'Datos', 10, '03-01-2019'),
            (5, 'ANMII', 10, '03-01-2019'),
            (5, 'Estructura', 10, '03-01-2019'),
            (5, 'ANMIII', 10, '03-01-2019'),
            (5, 'Algebra II', 10, '03-01-2019'),
            (5, 'Datos', 10, '03-06-2019'),
            (5, 'ANMII', 10, '03-06-2019'),
            (5, 'Estructura', 10, '03-06-2019'),
            (5, 'ANMIII', 10, '03-06-2019'),
            (5, 'Algebra II', 10, '03-06-2019'),
            (6, 'Datos', 5, '03-01-2019'),
            (7, 'Datos', 3, '03-01-2019'),
            (8, 'Datos', 8, '03-01-2019'),
            (9, 'Datos', 2, '03-01-2020'),
